				...
				Swal.fire({
					...
					onBeforeOpen: () => {
						...
						$.ajax({
							...
							url: base_url + 'kelola_pengajar/hapus_data', // Isi dengan url/path file php yang dituju
							data: {
								"ID": id,
	...
	function getTable() {
		Swal.fire({
			...
			onBeforeOpen: () => {
				...
				$.ajax({
					type: "POST", // Method pengiriman data bisa dengan GET atau POST
					url: base_url + 'kelola_pengajar/get_all_data', // Isi dengan url/path file php yang dituju
					dataType: 'JSON',
					success: function (data) { // Ketika proses pengiriman berhasil
