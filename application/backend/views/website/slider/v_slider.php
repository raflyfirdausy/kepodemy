				...
				<table class="table table-bordered table-hover table-checkable" id="table-slider" style="margin-top: 13px !important">
					...
					<tbody>
						<tr>
							...
							<td>Desa Digital</td>
							<td>Seluruh pelayanan dan informasi mengenai Desa Demo dapat di akses melalui internet dimanapun dan kapanpun</td>
							<td class="text-center">
								<button type="button" class="btn btn-sm btn-clean btn-icon btn-detail-slider" data-id="2" title="Detail Slider">
									<i class="la la-list-ul text-success"></i>
								</button>
								<button type="button" class="btn btn-sm btn-clean btn-icon btn-aktif-slider" data-id="2" title="Non aktifkan slider">
									<i class="la la-times-circle-o text-danger"></i>
								</button>
								<button type="button" class="btn btn-sm btn-clean btn-icon btn-edit-slider" data-id="2" title="Edit">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
				<div class="col-md-12">
					<input type="hidden" name="idSlider" id="id-slider" value="">
					...
					<div class="form-group row">
						...
						<input type="text" name="judulSlider" id="judul-slider" class="form-control" placeholder="Judul slider" required/>
					</div>
					<div class="form-group row">
