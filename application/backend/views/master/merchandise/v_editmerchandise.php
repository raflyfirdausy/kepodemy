						...
						<div class="col-lg-6">
							<div class="col-md-12">
								...
								<div class="form-group row">
									...
									<input type="text" name="harga" id="harga-merchandise" class="form-control valid-number" placeholder="0" value="<?= $data->harga ?>" required/>
								</div>
								<div class="form-group row">
									<label>Potongan <span class="text-muted">(optional)</span></label>
									<input type="text" name="harga_diskon" id="harga-diskon" class="form-control valid-number" value="<?= $data->harga_diskon ?>" placeholder="0"/>
								</div>
							</div>
						</div>
					</div>
