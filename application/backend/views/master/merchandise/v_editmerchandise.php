<form id="form-update-merchandise" method="POST">
<!--begin::Subheader-->
<div class="subheader py-2 py-lg-4  subheader-solid " id="kt_subheader">
	<div class=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
		...
		<div class="d-flex align-items-center flex-wrap mr-2">
			...
			<input type="hidden" id="id-merchandise" name="id" value="<?= $data->id ?>">
			<!--end::Page Title-->
				...
				<div class="col-md-12">
					<div class="form-group row">
						<div class="col-lg-6">
							<!-- <div class="card-body"> -->
                                <div class="mb-15">
								<img style="width: 100%" id="imgPreview" src="<?= isset($data->gambar) ?  asset("merchandise/" . $data->gambar) :  asset("gambar/ukuran-banner.jpg") ?>" alt="">
                                </div>
						...
						<div class="col-lg-6">
							<div class="col-md-12">
								<div class="form-group row">
									...
									<input type="text" name="nama" id="nama-merchandise" class="form-control" placeholder="Nama merchandise" value="<?= $data->nama ?>" required/>
								</div>
								<div class="form-group row">
									<label>Harga <span class="text-danger">*</span></label>
									<input type="text" name="harga" id="harga-merchandise" class="form-control valid-number currency" placeholder="0" value="<?= $data->harga ?>" required/>
								</div>
								<div class="form-group row">
									<label>Potongan <span class="text-muted">(optional)</span></label>
									<input type="text" name="harga_diskon" id="harga-diskon" class="form-control valid-number currency" value="<?= $data->harga_diskon ?>" placeholder="0"/>
								</div>
							</div>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-lg-12">
							...
							<textarea class="summernote" id="kt_summernote_1" name="keterangan"><?= $data->keterangan ?></textarea>
						</div>
