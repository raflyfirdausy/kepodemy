				...
				<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="input-group date">
										<input type="text" class="form-control datepicker" id="date-pembelajaran" name="tglPembelajaran" placeholder="Select date"/>
								...
								<div class="col-md-6">
									<div class="input-group">
										<input class="form-control timepicker" id="time-pembelajaran" name="jamPembelajaran" placeholder="Select time" type="text"/>
					...
					<div class="form-group row">
						<div class="col-lg-6">
							...
							<input type="text" class="form-control valid-number" name="harga" id="harga" placeholder="Masukkan harga" required/>
						</div>
						<div class="col-lg-6">
							<label>Akses Pembelajaran <span class="text-danger">*</span></label>
							<input type="text" class="form-control" name="aksespembelajaran" id="akses-belajar" placeholder="Ex: Link atau sejenisnya" required/>
						</div>
					</div>
					<div class="form-group row">
						<div class="col-lg-6">
