		...
		<div class="card card-custom">
			<div class="card-header">
				<div class="col-md-8 m-0 p-0">
					<div class="mt-8">
						<h3 class="card-label">Pendaftaran Pengajar - <span class="label label-xl label-success label-pill label-inline">Diterima</span></h3>
					</div>
				</div>
			...
			<div class="card-body">
				<!--begin: Datatable-->
				<table class="table table-bordered table-hover table-checkable" id="table-pengajar-terima" style="margin-top: 13px !important">
					<thead>
						<tr>
