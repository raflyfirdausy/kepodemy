...
<div class="d-flex flex-column-fluid">
	...
	<div class=" container ">
		...
		<div class="card card-custom">
			...
			<div class="card-body">
				<!--begin: Datatable-->
				<table class="table table-bordered table-hover table-checkable" id="table-pengajar-tolak" style="margin-top: 13px !important">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td class="text-center">
								<a href="<?= base_url('pengajar/detailpendaftar/1') ?>" type="button" class="btn btn-sm btn-clean btn-icon" title="Details">
