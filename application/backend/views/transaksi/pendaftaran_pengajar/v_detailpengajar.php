					...
					<ul class="nav nav-tabs nav-tabs-space-lg nav-tabs-line nav-tabs-bold nav-tabs-line-3x "
						...
						<li class="nav-item mr-3">
							<a class="nav-link" data-toggle="tab"
								...
								<span class="nav-text font-weight-bold">Attachment</span>
							</a>
						</li>
					</ul>
				</div>
			...
			<div class="card-body p-0">
				<div class="tab-content">
					...
					<div class="tab-pane" id="tab-pendidikan" role="tabpanel">
						<!--begin::Body-->
						<div class="card-body">
							<table class="table table-bordered table-checkable table-info-pengajar" id="table-pendidikan">
								<thead>
									<tr>
										<th>No</th>
					...
					<div class="tab-pane" id="tab-pekerjaan" role="tabpanel">
						<!--begin::Body-->
						<div class="card-body">
							<table class="table table-bordered table-checkable table-info-pengajar" id="table-pekerjaan">
								<thead>
									<tr>
										<th>No</th>
					...
					<div class="tab-pane" id="tab-attachment" role="tabpanel">
						...
						<div class="card-body">
							<!-- INFO Attachment -->
							<table class="table table-bordered table-checkable table-info-pengajar" id="table-attachment">
								<thead>
									<tr>
