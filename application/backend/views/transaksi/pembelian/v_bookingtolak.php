...
<div class="d-flex flex-column-fluid">
	...
	<div class=" container ">
		...
		<div class="card card-custom">
			<div class="card-header">
				...
				<div class="card-toolbar">
                    ...
                    <div class="col-md-8 m-0 p-0">
						<div class="mt-8">
							<h3 class="card-label">Transaksi Pembelian - <span class="label label-xl label-danger label-pill label-inline">Ditolak</span></h3>
						</div>
                    </div>
			...
			<div class="card-body">
				<!--begin: Datatable-->
				<table class="table table-bordered table-hover table-checkable" id="table-booking-tolak" style="margin-top: 13px !important">
					<thead>
						<tr>
...
<script src="<?= asset("admin/customjs/transaksi/booking-tolak.js") ?>"></script>
