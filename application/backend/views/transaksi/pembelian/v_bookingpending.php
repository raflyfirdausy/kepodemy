...
<div class="d-flex flex-column-fluid">
	...
	<div class=" container ">
		...
		<div class="card card-custom">
			<div class="card-header">
				...
				<div class="card-toolbar">
                    ...
                    <div class="col-md-8 m-0 p-0">
						<div class="mt-8">
							<h3 class="card-label">Transaksi Pembelian - <span class="label label-xl label-warning label-pill label-inline">Menunggu</span></h3>
						</div>
                    </div>
			...
			<div class="card-body">
				<!--begin: Datatable-->
				<table class="table table-bordered table-hover table-checkable" id="table-booking-pending" style="margin-top: 13px !important">
					<thead>
						<tr>
					...
					<tbody>
						<tr>
							...
							<td class="text-center">
								<a href="<?= base_url('bookingpembelian/detailbooking/0') ?>" type="button" class="btn btn-sm btn-clean btn-icon" title="Details">
...
<script src="<?= asset("admin/customjs/transaksi/booking-pending.js") ?>"></script>
